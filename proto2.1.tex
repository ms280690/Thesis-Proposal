...
From the Figure~\ref{tab:origgramp0201} we will focus on \xxx{the} \markWord{Term}\yyy{}{s,} since the others just
...
as a whole.\endnote{%
  Page break following removed.\newline
  \david{Mehul: remove this endnote if you have no questions about removing the pagebreak.}
}
