...
An atom is a general-purpose name with no inherent meaning. It is composed of a sequence of characters that is parsed by the Prolog\endnote{%
  Use \macroName{progLang}!
}
reader 
as a single unit.

Numbers can be floats or integers. Many Prolog\endnote{%
  Use \macroName{progLang}!
}
