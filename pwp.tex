...
\begin{enumerate}
\item Why a Logic Programming Languagee\eref{caps-choices} ?
...
commutative. Procedurally, however, it is often important to take into account Prolog's\endnote{%
  Use \macroName{progLang}!
}
 execution strategy, either for efficiency reasons, 
or due to the semantics of impure built-in predicates for which the order of evaluation matters. Also, as Prolog\endnote{%
  Use \macroName{progLang}!
}
