...
\end{singlespace}
\caption{\protect{\prologConstruct{append}} function in \progLang{Prolog}}
\label{tab:prlgappnd}
\end{code-list}
%
...
\begin{code-list}[H]
  ...
  \end{singlespace}
  \caption{A \protect{\prologConstruct{cut}}-free Prolog computation \cite{website:cutprologunionedu}}
...
\begin{code-list}[H]
  ...
  \end{singlespace}
  \caption{\protect{\prologConstruct{cut}}-free Prolog computation output\cite{website:cutprologunionedu}}
