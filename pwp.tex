...
\item Search strategy:
  ...
  \progLang{Prolog} simulates the non-deterministic choice of reducing clause by sequential search and
  backtracking.
...
As seen in Listing~\ref{tab:prlgprgrmtrceclauses} and Listing~\ref{tab:prlgprgrmtrceop} how \progLang{Prolog} resolves a query. 
