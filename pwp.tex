...
\progLang{Prolog} is a general purpose logic programming language mainly used in artificial intelligence and
  ...
  \progLang{Haskell}, implementations and publications exist which provide a starting point.
...
The description of how \progLang{Prolog} relates to logic programming is paraphrased from Chapter 6 of \cite{Sterling:1994:APA:175753}.
Logic programming languages are adapted from abstract interpreters for logic programs. 
To implement a logic programming language such as \progLang{Prolog} two major decisions about the resolver must be taken:
\begin{enumerate}
\item Scheduling policy:
\endnote{\david{say what a scheduling policy is}}
...
\endnote{\david{say what a search strategy is}}
...
For terminating queries \progLang{Prolog} generates all possible solutions of the goal with respect to the \progLang{Prolog} program. It performs a complete
...
\end{code-list}\endnote{\david{ma1e?}}

As seen in Listing~\ref{tab:prlgprgrmtrce} how \progLang{Prolog} resolves a query. 
