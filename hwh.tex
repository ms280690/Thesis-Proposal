...
\item Looking at \progLang{Haskell} as a tool for embedding domain specific languages\yyy{}{\Verb[showspaces]! !}\cite{website:paulspontifications}

\begin{enumerate}
\item Monads
\newline
Control flow defines the order/ manner of execution of statements in a pro\-gram\yyy{}{\Verb[showspaces]! !}\cite{website:controlflowwiki}.
...
computations not a control flow\yyy{}{\Verb[showspaces]! !}\cite{website:declarativeprogrammingwiki}.
