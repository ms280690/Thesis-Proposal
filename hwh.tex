...
% ---------------------------------------------------------------------------
\chapter{Haskell}\label{chap:hwh}
% ---------------------------------------------------------------------------
...
\paragraph{why \progLang{Haskell}?}
...
\paragraph{\progLang{Haskell} feature : Monads}
...
\paragraph{\progLang{Haskell} feature : Lazy evaluation}
