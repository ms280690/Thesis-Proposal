...
\progLang{Haskell} as a functional programming language \progLang{Haskell} is an advanced purely-functional
programminglanguage.
...
how a \progLang{Haskell} program is evaluated.
...
Along with \progLang{Haskell}'s existing support for domain specific languages, you are now free to use new
...
values.
Allow \progLang{Haskell} expressions and patterns to be constructed using domain specific, programmer-defined
...
Recapitulating, this chapter provided information on \progLang{Haskell} as a tool for embedding domain specific
languages. 
