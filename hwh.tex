...
Lazy evaluation is part of operational semantics, i.e. how a \progLang{Haskell} program is evaluated. This semantics allows one to bypass 
undefined values (e.g. results of infinite loops) and in this way it also allows one to process formally infinite data. 
...
value of the variable $p$ \cite{website:quasiquotationfreedictionary}. The variable $p$ is sometimes called a meta-syntactic variable.
...
Listing~\ref{tab:prlgappndhsklqq} shows us the advantages of quasi quotation (in this example there are no metasynctactic variables).
