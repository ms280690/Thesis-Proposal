...
\begin{code-list}[H]
  \begin{singlespace}
    \inputminted[linenos, firstline=35, lastline=69]{haskell}{haskell-monad-working-2.hs}
  \end{singlespace}
...
\begin{code-list}[H]
  \begin{singlespace}
    \inputminted[linenos, firstline=71, lastline=84]{haskell}{haskell-monad-working-2.hs}
  \end{singlespace}
