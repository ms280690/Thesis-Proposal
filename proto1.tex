...
\haskellClass{Functor}, \haskellClass{Foldable}, \yyy{}{and} \haskellClass{Traversable}\xxx{, \haskellClass{Applicative}}
\xxx{  and
\haskellClass{Monad}}.
...
The \haskellClass{Functor} and \haskellClass{Foldable} instances providing functions for applying map-reduce as described in Chapter~\ref{chap:relatedWork}.\endnote{%
...
\xxx{Lastly, the \haskellConstruct{Applicative} instance is an intermediate between a functor and a monad.}
