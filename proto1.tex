...
\textit{a} is the return type of the result of the computation in thread \textit{s}. The s keeps objects inside the 
...
This implementation uses \haskellConstruct{STVars}
but a custom implementation can be used inside the \haskellConstruct{BindingMonad}.
