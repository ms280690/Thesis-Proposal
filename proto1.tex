...
"FlatTerm"\endnote{%
  ...
  \texttt{@`\\code\char`\{FlatTerm\char`\}},
  where \texttt{\char`\\code} is a macro you define.
}
is separate
from its
...
a fix point does not move under \markWord{FlatTerm}.
...
Below \yyy{}{\Huge Figure~}\ref{fig:Functor Hierarchy} shows the relation between the different classes.
