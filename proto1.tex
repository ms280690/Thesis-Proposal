...
This prototype demonstrates the process of creating an isomorphic data type to replicate the target language type system while conforming 
to the host language.\endnote{
  \david{``\textit{the benefits}'' of what?}
	\mehul{changed}
}
...
\progLang{Haskell} provides it in two forms, as a function and as a constructor.\endnote{%
...
\codeLibrary{unifiication-fd} library (\cite{unification-fd-lib}) for the unification algorithm to work.\endnote{%
