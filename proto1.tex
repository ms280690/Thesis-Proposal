...
\item Variable implementations\endnote{%
...
difference.
It means that applying one more \haskellConstruct{FlatTerm} would not change anything \yyy{–}{--}\eref{non-ascii}\textsuperscript{,}\endnote{%
...
\item \eref{no-and} In type constructor form,
...
Our language now opened up and \endnote{%
