...
We have a \progLang{Prolog}-like language in \progLang{Haskell} defined via \haskellConstruct{data}. The language defined is recursive in 
nature. 
We convert it into a non-recursive data type. Basically we do unification monadically.
