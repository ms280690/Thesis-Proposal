...
The Functor and Foldable instances providing functions for applying map-reduce to the data structure. The primary issue is that at the end 
...
Enter, Traversable, it allows reduce whilst preserving the shape of the structure. Lastly, the Applicative instance is an intermediate 
...
in tandom with the UTerm. The UTerm data type captures the recursive structure of logic terms i.e, given some functor t which describes the 
