...
\haskellConstruct{FlatTerm} is separate from the type of its subterms\endnote{%
...
(see \cite{website:kindhaskellwiki}).\endnote{%
...
} fixed point does not move under \haskellConstruct{FlatTerm}.
