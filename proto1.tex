...
The other part is to reach a point where two terms are required to be unified i.e. searching.\endnote{%
...
We have a \progLang{Prolog}-lik language in \progLang{Haskell} defined via \textit{data}.
