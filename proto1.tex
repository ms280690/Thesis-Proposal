...
This works in \yyy{tandom}{tandem} with the \Verb!UTerm! data type.
...
variable for each language variable\yyy{.}{as shown in Figure~\ref{tab:varsToDictM}.}
...
The dictionary along with the fixed point version flattened of the term\yyy{}{, as shown in Figure~\ref{tab:to-UTerm}}
%
\begin{figure}
  \begin{minted}[linenos,gobble=2]{haskell}
  uTermify
...
\end{figure}
%
and for later use to convert them back, \yyy{}{as shown in Figure~\ref{tab:from-UTerm}.} 
%
\begin{figure}
  \begin{minted}[linenos,gobble=2]{haskell}
...
\yyy{}{as shown in Figure~\ref{tab:unification} and Figure~\ref{tab:unif-driver}.}
%
\begin{figure}
\begin{minted}[linenos]{haskell}
  monadicUnification :: 
...
The final reconversion to return a list of substitutions\yyy{}{,
