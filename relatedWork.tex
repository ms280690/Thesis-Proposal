...
\begin{code-list}[th]
  \begin{singlespace}
    \inputminted[linenos, firstline=160, lastline=169]{haskell}{haskell-monad-working.hs}
  \end{singlespace}
...
\begin{code-list}[th]
  \begin{singlespace}
    \inputminted[linenos, firstline=171, lastline=218]{haskell}{haskell-monad-working.hs}
  \end{singlespace}
...
\begin{code-list}[th]
  \begin{singlespace}
    \inputminted[linenos, firstline=223, lastline=247]{haskell}{haskell-monad-working.hs}
  \end{singlespace}
