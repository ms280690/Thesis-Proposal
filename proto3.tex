...
the resolver searches to create and a list of sub goals and then tries to achieve each one.
...
\subsection{Syntax Modification}
\begin{minted}[linenos]{haskell}
{-# LANGUAGE  DeriveDataTypeable, 
              ViewPatterns, 
              ScopedTypeVariables, 
