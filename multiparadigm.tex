...
languages, i.e. functional logical programming languages.\endnote{%
...
approach but for \progLang{Haskell} \cite{website:haskellkanren,website:molog,website:minikanrent}.
\endnote{%
