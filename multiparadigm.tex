...
Beginning with the ones from Australia, which seems to be a popular destination for fiddling with \progLang{Prolog}
...
Starting with \progLang{Mercury} which a boundary between deterministic and non-deterministic programs, similarly
\progLang{Nue Prolog} has special support for functions while \progLang{Oz} gives concurrent constraint programming
