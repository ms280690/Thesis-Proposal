...
\cite{website:wikimultiparadigm} \yyy{"}{``}The idea of a multi paradigm language is to provide a framework in which
programmers can work in a variety of styles, freely intermixing constructs from different paradigms.\yyy{"}{''}
...
A lot has been talked and discussed on coming to clear grounds about the classification of programming languages. If the conventional ideology is
...
\item[$\bullet$] Multi Paradigm Languages
  ...
  As as always since we are talking about \progLang{Haskell} we have to include monads and unifying theories using
