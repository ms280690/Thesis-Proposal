...
languages namely, functional logical programming languages.\endnote{%
  This is a sentence fragment.
}
By doing so a large amount of information pops up, from articles that give brief description and mentions
\cite{website:wikiflpl, website:wikiflpllist} to \yyy{}{articles that give} \yyy{the implementing}{implementation} techniques\endnote{%
  Are the previous two fixes correct?
  If so, remove this endnote.
}
\cite{website:imlpementingflpl}\yyy{}{\Large,} which \yyy{}{also}
\yyy{and}{give} a brief overview of the aim and also the list of publications.\endnote{%
