...
styles of programming \cite{website:wikimpllist,website:dmoz}.\endnote{%
    Yet another metaphor that doesn't spin my wheels.\newline
    \mehul{changed}\newline
    \david{Now I just do not understand.}
    \mehul{changed}
}
...
languages namely i.e. functional logical programming languages.\endnote{%
...
\cite{website:imlpementingflpl}, which also give a brief overview of the aim and also the list of publications.\endnote{%
...
This is the case with most of the languages of the paradigm, hardly a few have survived. as the new ones incorporated
...
\end{inparaenum}
have been included below, as the list is long and not the main focus of the thesis.\endnote{%
  Make the change and delete this footnote.
  I believe that adding ``\textsl{below}'' makes this sentence a lot clearer.
}
We begin with
variants of
\progLang{Prolog}.
...
programming plus distributed support, with different function types for goal solving and expression rewriting.\endnote{%
...
order functions and lazy evaluation.
 We take a look at \progLang{Prolog} variants: \progLang{Ciao} \enparen{\cite{website:ciao}} is a preprocessor
    ...
    \enparen{\cite{bert1987lpg,malachi1984tablog}}.\endnote{%
...
The functional language \progLang{Scheme} is a very popular choice for adding logic programming functionality to a funcitonal 
language.\endnote{%
  What sort of thing?
}
The book \cite{friedman05reasoned} and an implementation to accompany
\cite{website:kanren,website:minkanren}, 
which seems to have translated the approach into \progLang{Haskell}, 
\cite{website:haskellkanren,website:molog,website:minikanrent}.\endnote{%
