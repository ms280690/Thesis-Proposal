...
The \codeLibrary{prolog-0.2.0.1} \cite{prolog-lib} was written by Matthias Bartsch and consists of 14 \progLang{Haskell} files. It 
...
and leaves very little to no scope for extension. Figure~\ref{fig:prlg0201architecture} describes its architecture.\endnote{%
...
They specifically contain parts of a compiler (see Figure~\ref{fig:Phases of Compiler}).\endnote{%
...
-> em m (UTerm t v)|
		\end{minted}
	\end{singlespace}
\caption{\haskellConstruct{unify} type signature}
...
\begin{code-list}[H]
  \begin{singlespace}
    \inputminted[linenos,firstline=96, lastline=105]{haskell}{haskell-proto2-monadic-unification-tests-and-extraction.hs}
  \end{singlespace}
...
\begin{code-list}[H]
  \begin{singlespace}
    \inputminted[linenos,firstline=123, lastline=132]{haskell}{haskell-proto2-monadic-unification-tests-and-extraction.hs}
  \end{singlespace}
\caption{f1 function}
...
\begin{code-list}[H]
  \begin{singlespace}
    \inputminted[linenos,firstline=108, lastline=120]{haskell}{haskell-proto2-monadic-unification-tests-and-extraction.hs}
  \end{singlespace}
