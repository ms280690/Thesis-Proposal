...
After the language is opened up, the next step is to replace the current unification procedure to the one similar to Chapter~\ref{proto1}.{\Huge
  ?\endnote{%
...
Takes two fixed flat terms and converts them into UTerms. Performs unification on them inside the \haskellConstruct{Binding Monad} and 
