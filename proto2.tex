...
Recapitulating, this chapter provided an implementation of a \prologConstruct{Prolog}-like language adopted from \cite{prolog-lib} and
incorporated a monadic unifier built from \cite{unification-fd-lib} to create a \progLang{Prolog} query resolver.
