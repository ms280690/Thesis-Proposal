...
\item
  ...
  a result.
  Another implementation \cite{website:takashi-workplace}, simplifies the notation of \progLang{Prolog} literals to a list format.
...
Here is a list of problems mentioned in the sections above that this thesis tackles:
\begin{enumerate}
...
\item The implementation is not  Read-Eval-Print Loop (REPL) based. You can write a program file and compile and run it like a normal \progLang{Haskell} file.
\end{enumerate}
