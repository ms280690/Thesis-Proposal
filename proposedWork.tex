...
\item
  ...
  proposed concepts \cite{spivey1999embedding, seres1999algebra, seres2001algebra, spivey2000functional, seres2000optimisation}.\endnote{%
...
\item
  Moreover, none of the above have natural list support that exist in \progLang{Prolog}.\endnote{%
    What does this point mean?
    I would have to think I do not remember.
}
\end{enumerate}
...
Secondly, exploring aspects such as \textit{assert} and database capabilities.\endnote{%
  Strike this?
  well we/ the library does some of this right ?
