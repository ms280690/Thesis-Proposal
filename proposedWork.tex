...
(\chapterReference{proto2.1}{Prototype 2}) does the what a \progLang{Prolog} query resolver would do given a query and a knowledge base. 
...
(\chapterReference{proto3}{Prototype 3}) demonstrates the modularity of the query resolver with variable search strategies. Unification 
is. 

(\chapterReference{proto4}{Prototype 4}) throws light on how IO operations can be embedded into the abstract syntax of a DSL.  
