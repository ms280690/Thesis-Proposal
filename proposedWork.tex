...
\item
  ...
  Many provide only a shell through which one has to do\eref{must-have-to} all the work, which is synonymous with
...
As discussed in the above,\endnote{%
...
Taking into consideration above, there is quite some room for improvement and additions.\endnote{%
...
close to a \progLang{Prolog}-like\eref{language-like} language and has practical abilities to carry out real-world
tasks.
They include predicates such as\eref{such-as-like} \prologConstruct{cut}\endnote{%
