...
and specifically \progLang{Haskell}. Moreover, we take a look at their shortcomings to get a direction for improvements and contributions 
of this thesis. This chapter provides details of the improvements that have been built on top of the existing work.
\mehul{What i want to say is that we looked at a lot of stuff and then found these problems. Now these problems are like points for 
improvement. Also we wanted to add some other things like monadic unification. }
...
\item
  ...
  in \progLang{Prolog} i.e. having a list of different types of \progLang{Prolog} constructs.\endnote{%
    ...
    \mehul{as per our discussion on wednesday 9 feb, what shall I do ?}
    }
}
\end{enumerate}
...
provides the contributions of the thesis which are not necessarily built upon the existing work and more from scratch.\mehul{which came out of our heads, new stuff! }
