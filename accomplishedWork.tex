...
Having looked at the existing work for embedding \progLang{Prolog} in \progLang{Haskell} along with the suggestions for improvement in the previous chapter, 
...
Most languages have a recursive abstract syntax which restricts the embedded, domain-specific language
  \enparen{eDSL, see p.~\pageref{sec:DSL-def}}
