...
However,\butbut{\mehul{changed}} all is not that straight forward when shifting from one language to another.
...
external DSL (eDSL)\endnote{%
  If you want to use the abbreviation ``\textit{eDSL}'' in 4.3.1 you need to define it.
}\elabel{eDSL1}
