...
However there are a lot of good things about \progLang{Prolog}\endnote{%
  naked \progLang{Prolog}.
}
...
Putting all of the above together, Domain Specific Languages\endnote{%
  \david{This footnote changed 2016-01-08.
    ...
    \mehul{added content for dsl, please see previous paragraph}
  }%
}
...
on.\endnote{%
  ...
  \mehul{how do I say that mathematics can be translated to program easily in declarative paradigm}
}
...
\item [Embedding (\chapterReference{chap:embedding}{Chapter 4}):]
  ...
  Examples and further discussion on the same are\endnote{%
