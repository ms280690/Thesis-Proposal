...
external DSL is constructed from scratch, starting from definition of the desired syntax to implementation of the associated parser for reading it. In contrast, internal or embedded DSL are constructed on top of an existing host language \cite{machadomodel}.
...
The downside is that such general purpose languages\endnote{%
  \mehul{find a cute metaphor}
}
