...
The methodologies that have stood out are the functional and logical approaches.\endnote{%
  ...
  \mehul{none at the moment
  but I will change certain capitals to small}
}
The former is based on functions and lambda calculus, while the latter is based on Horn clause logic.
Each of them has its own advantages and \yyy{ﬂaws}{flaws}\endnote{%
...
hassle of jumping between the two\yyy{}{\Large,} more commonly known as an embedded or a foreign function interface.\endnote{%
...
lack focus and approaching towards the solution\endnote{%
...
is to solve the problem since \yyy{it}{the solution} need not be moulded according to the capability  of the
language.
...
The subject in question here is \progLang{Haskell} and the split personality being \progLang{Prolog}. How far can \progLang{Haskell} be pushed to
...
This can be achieved in two ways\yyy{,}{:}\endnote{%
