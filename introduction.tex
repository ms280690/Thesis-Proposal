...
On the other hand, a general purpose language can be used for solving a wide variety of problems but \yyy{many a
  times,}{often} the programmer ends up writing some code dictated by the language rather than\yyy{}{ by} the
problem.
