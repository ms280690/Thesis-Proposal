...
The aim of this prototype is to embed \languageConstruct{IO} operations within the definition on an eDSL so as to allow the chaining and 
control of operations of the language irrespective of them pure or impure.
...
\begin{code-list}[H]
\begin{singlespace}
\inputminted[linenos, firstline=196, lastline=228]{haskell}{IOSketchM.hs}
\end{singlespace}
