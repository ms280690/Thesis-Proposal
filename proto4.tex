...
Notice that the only terminal constructor is \markWord{Return} --
...
You can now load up \markWord{GHCi} and apply run to any action --
...
and it will never do anything except reading from \markWord{stdin} and writing to \markWord{stdout} (not that those things aren't potentially dangerous in themselves, but\dots)
