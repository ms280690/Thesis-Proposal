...
\end{minted}
It will surprise no one to learn that \haskellConstruct{IOAction} is a monad. In fact we've already defined the necessary bind operation in \haskellConstruct{seqio}, so getting 
