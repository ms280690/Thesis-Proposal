...
language to incorporate \haskellConstruct{monads} \cite{wadler1992comprehending} for safe input and output.
...
one programming language can make use of services written in another.\eref{not-a-sentence} For example, a function
