...
The selection of languages is not uncommon and this not only the case with \progLang{Haskell, Prolog} seems 
...
A specific tool used in meta programming is quasi quotation \cite{mainland2007s,haskellquasi,wikiquasi}, permits \progLang{Haskell} expressions 
...
first and the resulting lists and then recurs on the tails. The same in \progLang{Haskell},
...
Consider the Object Functional Programming Language, \progLang{Scala} \cite{website:scala}, it is purely functional but with objects 
