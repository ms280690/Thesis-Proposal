...
etc; they are variables whose values are often variables (as in usages like \yyy{“}{``}the value of f(foo,bar) is
the sum of foo and bar\yyy{”}{''}).
However, it has been plausibly suggested that the real reason for the term \yyy{“}{``}metasyntactic
variable\yyy{”}{''} is that it sounds good.
