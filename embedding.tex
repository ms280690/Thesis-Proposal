...
\textit{logicalised} and applied to \progLang{Prolog} programs. \progLang{Prolog} is based on relations and \progLang{Haskell} is based on
functions; \cite{spivey2000functional} takes this into consideration and attempts to model relations using functions.\endnote{%
