...
\noindent\rule{0.95\textwidth}{2.8pt}\endnote{%
  Section heading and dividing line moved into the Chapter.
}
...
To replicate \progLang{Prolog}{\Huge -}like
...
\section{Chapter Recap\protect{\Huge\color{red} itulation}}
