...
The more specific the feature\yyy{}{\Large,} the lesser the support in Haskell.
Moving on to the other distinct feature of Prolog is Unification,\endnote{%
  comma splice
}\textsuperscript{,}\endnote{%
  ``Moving on to the other distinct feature of Prolog is Unification.''?  Say it aloud.
}
two libraries exist \cite{unification-fd-lib},
