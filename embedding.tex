...
Before moving on to the formal content such as publications, modules and libraries\yyy{}{\Large,} let's take a look
...
and a lot of practical features that \progLang{Prolog} has.
...
enables encoding of search problems\yyy{}{in \progLang{Haskell} rather than
...
There are two libraries \xxx{that exist} \xxx{\cite{unification-fd-lib}} \yyy{,
  \cite{cmu-lib}}{(\cite{unification-fd-lib}, \cite{cmu-lib})} that unify two \progLang{Prolog} terms and return
the resulting substitution.\endnote{% 
