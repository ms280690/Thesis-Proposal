...
The next subsection covers this literature.\endnote{%
...
to the other.
Publications such as \cite{erwig2004escape} attempt at exercising \progLang{Haskell} features without adding any new 
constructs.\endnote{%
