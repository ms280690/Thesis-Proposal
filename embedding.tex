...
\subsection{Logic Libraries}
  ...
  \cite{logict-lib} is a continuation-based, backtracking, logic programming monad which attempts \yyy{at
    replicating}{to replicate}\endnote{%
...
\cite{cmu-lib} that unify two \yyy{Prolog}{\progLang{Prolog}} \yyy{Terms}{terms} and return the resulting
